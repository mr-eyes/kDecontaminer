finished = [("Ast29B",	"GCF_000759875.1_ASM75987v1_genomic"),
("Ast44B",	"GCA_000211355.2_ASM21135v2_genomic"),
("Ast27B",	"GCA_000211355.2_ASM21135v2_genomic"),
("Ast44B",	"GCF_000372725.1_Emiliana_huxleyi_CCMP1516_main_genome_assembly_v1.0_genomic"),
("Ast44B",	"GCA_001618945.1_ASM161894v1_genomic"),
("Ast44B",	"GCF_000149405.2_ASM14940v2_genomic"),
("Ast44B",	"Cadsp1_AssemblyScaffolds"),
("Ast29B",	"con_Xtes.genome_assembly"),
("Ast29B",	"GCA_000397085.1_Porphyridium_purpureum_genomic"),
("Ast27B",	"GCF_000150955.2_ASM15095v2_genomic"),
("Ast27B",	"GCA_003354225.1_ASM335422v1_genomic"),
("Ast27B",	"Cadsp1_AssemblyScaffolds"),
("Ast29B",	"con_Scar.genome_assembly"),
("Ast44B",	"con_Scar.genome_assembly"),
("Ast36C",	"GCA_000507305.1_ASM50730v1_genomic"),
...
("AW2C",	"con_Scar.genome_assembly"),
("AW3D",	"con_Scar.genome_assembly"),
("Ast42B",	"con_Scar.genome_assembly"),
("Ast34D",	"con_Scar.genome_assembly"),
("AW8D",	"con_Scar.genome_assembly"),
("Ast35D",	"con_Scar.genome_assembly"),
("Ast25B",	"con_Scar.genome_assembly"),
("Ast30A",	"con_Scar.genome_assembly"),
("Ast27B",	"con_Scar.genome_assembly"),
("Ast36C",	"con_Scar.genome_assembly"),
("Ast34D",	"con_Xtes.genome_assembly"),
("AW3D",	"con_Xtes.genome_assembly"),
("Ast36C",	"con_Xtes.genome_assembly"),
("AW2C",	"con_Xtes.genome_assembly"),
("Ast42B",	"con_Xtes.genome_assembly"),
("AW8D",	"con_Xtes.genome_assembly"),
("Ast25B",	"con_Xtes.genome_assembly"),
("Ast35D",	"con_Xtes.genome_assembly"),
("Ast30A",	"con_Xtes.genome_assembly"),
("Ast44B",	"con_Xtes.genome_assembly"),
("Ast27B",	"con_Xtes.genome_assembly"),
("Ast42B",	"coral_Mcav.genome_assembly"),
("Ast35D",	"coral_Mcav.genome_assembly"),
("AW3D",	"coral_Mcav.genome_assembly"),
("Ast36C",	"coral_Mcav.genome_assembly"),
("AW2C",	"coral_Mcav.genome_assembly"),
("Ast34D",	"coral_Mcav.genome_assembly"),
("Ast30A",	"coral_Mcav.genome_assembly"),
("AW8D",	"coral_Mcav.genome_assembly"),
("Ast25B",	"coral_Mcav.genome_assembly"),
("Ast29B",	"coral_Mcav.genome_assembly"),
("Ast34D",	"apoculata.assembly.scaffolds_chromosome_level"),
("Ast36C",	"apoculata.assembly.scaffolds_chromosome_level"),
("AW2C",	"apoculata.assembly.scaffolds_chromosome_level"),
("Ast42B",	"apoculata.assembly.scaffolds_chromosome_level"),
("AW8D",	"apoculata.assembly.scaffolds_chromosome_level"),
("Ast25B",	"apoculata.assembly.scaffolds_chromosome_level"),
("Ast35D",	"apoculata.assembly.scaffolds_chromosome_level"),
("Ast44B",	"apoculata.assembly.scaffolds_chromosome_level"),
("Ast30A",	"apoculata.assembly.scaffolds_chromosome_level"),
("Ast27B",	"apoculata.assembly.scaffolds_chromosome_level"),
("AW3D",	"apoculata.assembly.scaffolds_chromosome_level"),
("Ast34D",	"Cadsp1_AssemblyScaffolds"),
("AW3D",	"Cadsp1_AssemblyScaffolds"),
("AW2C",	"Cadsp1_AssemblyScaffolds"),
("Ast36C",	"Cadsp1_AssemblyScaffolds"),
("Ast35D",	"Cadsp1_AssemblyScaffolds"),
("AW8D",	"Cadsp1_AssemblyScaffolds"),
("Ast30A",	"Cadsp1_AssemblyScaffolds"),
("Ast25B",	"Cadsp1_AssemblyScaffolds"),
("Ast29B",	"Cadsp1_AssemblyScaffolds"),
("Ast42B",	"Cadsp1_AssemblyScaffolds"),
("Ast29B",	"GCF_004143615.1_amil_sf_1.1_genomic"),
("Ast30A",	"GCF_004143615.1_amil_sf_1.1_genomic"),
...
("Ast29B",	"con_Cfor.transcriptome"),
("Ast44B",	"con_Cfor.transcriptome"),
("AW3D",	"con_Cfor.transcriptome"),
("AW2C",	"con_Cfor.transcriptome"),
("Ast42B",	"con_Cfor.transcriptome"),
("AW8D",	"con_Cfor.transcriptome"),
("Ast35D",	"con_Cfor.transcriptome"),
("Ast36C",	"con_Cfor.transcriptome"),
("Ast34D",	"con_Cfor.transcriptome"),
("Ast27B",	"con_Cfor.transcriptome"),
("Ast30A",	"con_Cfor.transcriptome"),
("Ast25B",	"con_Cfor.transcriptome")]
...
for sample, genome in job_pairs:
    for finished_sample, finished_genome in finished:
        ...
        if finished_sample in sample and finished_genome in genome:
            break
    else:
